        ...
        <div class="container pt-4 bg-white">
            <div class="row">
                <div class="col-md-8 col-xl-6">
                    ...
                    <form action="{{ route('phone.update', ['phone' => $phone->id]) }}" method="post">
                        @method('PUT')
                        @csrf
                        <div class="mb-3">
                            <label for="imei" class="form-label">No IMEI</label>
                            <input type="text" id="imei" name="imei"
                                value="{{ old('imei') ?? $phone->imei }}"
                            ...
                            <div class="d-flex">
                                <div class="form-check me-3">
                                    <input type="radio" class="form-check-input" name="status" id="resmi"
                                        value="resmi"
                                        {{ (old('status') ?? $phone->status) == 'resmi' ? 'checked' : '' }}>
